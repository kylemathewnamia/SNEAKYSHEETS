...
<body>
    <header class="dashboard-header">
        <div class="logo">
            <i class="fas fa-gamepad"></i> SneakyPlay2
        </div>
    ...
    <div class="dashboard-container">
        <nav class="sidebar">
            ...
            <a href="settings.php"><i class="fas fa-user-circle"></i> Account Settings</a>
        </nav>
                        ...
                        <?php foreach ($popular_products as $product): ?>
                            <div class="product-card">
                                <div class="product-image">
                                    <img src="https://picsum.photos/seed/product<?php echo $product['product_id']; ?>/200/150.jpg"
                    ...
                    <?php if (!empty($special_offers)): ?>
                        <?php foreach ($special_offers as $offer): ?>
                            <div class="offer-card">
                                ...
                                <img src="https://picsum.photos/seed/offer<?php echo $offer['product_id']; ?>/200/150.jpg"
                                ...
                                <button class="btn btn-primary view-product"
                                    data-product-id="<?php echo $offer['product_id']; ?>">
                                    Shop Now
                                </button>
                            </div>
                        <?php endforeach; ?>
